          ...
          <div className="navbar-header">
            ...
            <Nav pullRight>
              <DropdownButton noCaret pullRight
                  title={ _.times( 3, () => <span className="icon-bar"></span> )}
                  className="navbar-toggle navbar-right" id="bg-nested-dropdown">
                <MenuItem><Link to="/createActivity"><text className="text-success">
                  <span className="glyphicon glyphicon-plus"></span> Create Activity</text></Link></MenuItem>
                <MenuItem divider />
            ...
            <ul className="nav navbar-nav navbar-left">
              <li>
                <Link to="/createActivity">
                  <text className="text-success"><span className="glyphicon glyphicon-plus"></span> Create Activity</text>
                </Link>
              </li>
            </ul>
